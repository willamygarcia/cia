...
<body>
	...
	<div id="conteiner">
		<nav class="nav_tabs">
			<h3 class="titulo-cadastro">Cadastro de Cidadão</h3>
					...
					<ul>
								...
								<div class="tab-content">
									...
									<div class="form-row">
										...
										<div class="form-group col-md-2">
											...
											<input type="text" class="form-control" id="orgaoEmissor" name="orgaoEmissor"  maxlength="5" aria-describedby="orgaoEmissorHelp" placeholder="Orgão Emissor"  value="${cidadao.orgaoEmissor}">
										</div>
										<div class="form-group col-md-2">
						...
						<li>
							...
							<div class="tab-content">
								...
								<div class="form-row">
									<div class="form-group col-md-2">
										<label for="dataInfracao">Data da Utima Infração</label>
						...
						<li>
							...
							<div class="tab-content">
								...
								<fieldset>
									...
									<div class="form-row">
										<div class="form-group col-md-6">
											<label for="bracoDireito" >Braço(Obro até as Mãos) Direito</label>
										...
										<div class="form-group col-md-6">
											<label for="bracoEsquerdo">Braço(Obro até as Mãos) Equerdo</label>
									...
									<div class="form-row">
										<div class="form-group col-md-6">
											<label for="pernaDireita" >Perna(Coxa até os Pes) Direita</label>
										...
										<div class="form-group col-md-6">
											<label for="pernaEsquerda">Perna(Coxa até os Pes) Esquerda</label>
									...
									<div class="form-row">
										<div class="form-group col-md-12">
											<label for="torax">Costas(Toda Região)</label>
